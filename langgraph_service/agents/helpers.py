...
def build_degraded_finding(
    agent: str, status_code: int, message: str, error_category: str
) -> dict[str, Any]:
    """
    ...
    return {
        ...
        "evidence": {"backend": "mock-go-backend", "status_code": status_code},
    }
...
def collect_topology_data() -> dict[str, Any]:
    """
...
def collect_metrics_data(
    alert: dict[str, Any], time_window: dict[str, str] | None = None
) -> dict[str, Any]:
    """
