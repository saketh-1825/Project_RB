...
def human_review_node(state: AnalysisState) -> AnalysisState:
    ...
    confidence_reason = confidence.get("reason", "Confidence score below threshold")
    ...
    state["interrupt_question"] = (
        "Confidence score is below threshold. Please review the collected evidence and provide context."
    )
